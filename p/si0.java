...
public final class si0 extends b implements u74	// class@002631 from classes.dex
{

    public void si0(){
       super(Collection2V2$CollectionItem.e());
    }
    ...
    public final void c(boolean p0){
       this.copyOnWrite();
       Collection2V2$CollectionItem.g(this.instance, p0);
    }
    ...
    public final void d(String p0){
       this.copyOnWrite();
       Collection2V2$CollectionItem.f(this.instance, p0);
    }
