...
public final class gy1 extends b implements u74	// class@0017a0 from classes.dex
{

    public void gy1(){
       super(FacebookAccessToken.e());
    }
    ...
    public final void c(String p0){
       this.copyOnWrite();
       FacebookAccessToken.g(this.instance, p0);
    }
    ...
    public final void d(String p0){
       this.copyOnWrite();
       FacebookAccessToken.f(this.instance, p0);
    }
