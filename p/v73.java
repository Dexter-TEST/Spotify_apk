...
public final class v73 extends b implements u74	// class@002997 from classes.dex
{

    public void v73(){
       super(InAppMessageBackendRequestErrorEvent.e());
    }
    ...
    public final void c(String p0){
       this.copyOnWrite();
       InAppMessageBackendRequestErrorEvent.h(this.instance, p0);
    }
    ...
    public final void d(String p0){
       this.copyOnWrite();
       InAppMessageBackendRequestErrorEvent.f(this.instance, p0);
    }
    public final void e(int p0){
       this.copyOnWrite();
       InAppMessageBackendRequestErrorEvent.g(this.instance, p0);
    }
    public final void f(String p0){
       this.copyOnWrite();
       InAppMessageBackendRequestErrorEvent.i(this.instance, p0);
    }
