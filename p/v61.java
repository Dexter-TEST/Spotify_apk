...
public final class v61 extends b implements u74	// class@00298c from classes.dex
{

    public void v61(){
       super(DefaultConfigurationAppliedNonAuth.e());
    }
    ...
    public final void c(TreeMap p0){
       this.copyOnWrite();
       DefaultConfigurationAppliedNonAuth.h(this.instance).putAll(p0);
    }
    ...
    public final void d(String p0){
       this.copyOnWrite();
       DefaultConfigurationAppliedNonAuth.i(this.instance, p0);
    }
    public final void e(){
       this.copyOnWrite();
       DefaultConfigurationAppliedNonAuth.g(this.instance);
    }
    public final void f(){
       this.copyOnWrite();
       DefaultConfigurationAppliedNonAuth.j(this.instance);
    }
    public final void g(){
       this.copyOnWrite();
       DefaultConfigurationAppliedNonAuth.f(this.instance);
    }
