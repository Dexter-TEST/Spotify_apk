...
public final class pd0 extends b implements u74	// class@00223a from classes.dex
{

    public void pd0(){
       super(ChallengeSolutions.e());
    }
    ...
    public final void c(ChallengeSolution p0){
       this.copyOnWrite();
       ChallengeSolutions.f(this.instance, p0);
    }
