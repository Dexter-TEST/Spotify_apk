...
public final class qi7 extends b implements u74	// class@0023ad from classes.dex
{

    public void qi7(){
       super(ViewLoadSequence.e());
    }
    ...
    public final void c(LinkedHashMap p0){
       this.copyOnWrite();
       ViewLoadSequence.h(this.instance).putAll(p0);
    }
    ...
    public final void d(LinkedHashMap p0){
       this.copyOnWrite();
       ViewLoadSequence.g(this.instance).putAll(p0);
    }
    public final void e(int p0){
       this.copyOnWrite();
       ViewLoadSequence.l(this.instance, p0);
    }
    public final void f(String p0){
       this.copyOnWrite();
       ViewLoadSequence.j(this.instance, p0);
    }
    public final void g(String p0){
       this.copyOnWrite();
       ViewLoadSequence.f(this.instance, p0);
    }
    ...
    public final void h(String p0){
       this.copyOnWrite();
       ViewLoadSequence.i(this.instance, p0);
    }
    public final void i(String p0){
       this.copyOnWrite();
       ViewLoadSequence.k(this.instance, p0);
    }
    ...
    public final void j(String p0){
       this.copyOnWrite();
       ViewLoadSequence.n(this.instance, p0);
    }
    public final void k(String p0){
       this.copyOnWrite();
       ViewLoadSequence.m(this.instance, p0);
    }
