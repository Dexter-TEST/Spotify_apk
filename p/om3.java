...
public final class om3 extends b implements u74	// class@00214b from classes.dex
{

    public void om3(){
       super(LiteAppForegroundNonAuth.e());
    }
    ...
    public final void c(boolean p0){
       this.copyOnWrite();
       LiteAppForegroundNonAuth.f(this.instance, p0);
    }
    ...
    public final void d(){
       this.copyOnWrite();
       LiteAppForegroundNonAuth.g(this.instance);
    }
