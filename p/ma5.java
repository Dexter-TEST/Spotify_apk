...
public final class ma5 extends b implements u74	// class@001e59 from classes.dex
{
    ...
    public final void c(String p0){
       this.copyOnWrite();
       PhoneNumber.h(this.instance, p0);
    }
    ...
    public final void d(String p0){
       this.copyOnWrite();
       PhoneNumber.g(this.instance, p0);
    }
    public final void e(String p0){
       this.copyOnWrite();
       PhoneNumber.f(this.instance, p0);
    }
