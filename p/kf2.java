...
public final class kf2 extends b implements u74	// class@001bff from classes.dex
{
    ...
    public final void c(ab2 p0){
       this.copyOnWrite();
       FragmentsContainer.g(this.instance, p0);
    }
    ...
    public final void d(Fragment p0){
       this.copyOnWrite();
       FragmentsContainer.f(this.instance, p0);
    }
    public final void e(bd2 p0){
       this.copyOnWrite();
       FragmentsContainer.f(this.instance, p0.build());
    }
