...
public final class l30 extends b implements u74	// class@001cd3 from classes.dex
{

    public void l30(){
       super(Bootstrap$BootstrapRequest.e());
    }
    ...
    public final void c(Bootstrap$TrialsFacadeRequestV1 p0){
       this.copyOnWrite();
       Bootstrap$BootstrapRequest.g(this.instance, p0);
    }
    ...
    public final void d(b p0){
       this.copyOnWrite();
       Bootstrap$BootstrapRequest.f(this.instance, p0.build());
    }
