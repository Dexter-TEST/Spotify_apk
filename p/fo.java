...
public final class fo extends b implements u74	// class@00160c from classes.dex
{

    public void fo(){
       super(AudioManagerProxyEvent.e());
    }
    ...
    public final void c(boolean p0){
       this.copyOnWrite();
       AudioManagerProxyEvent.l(this.instance, p0);
    }
    ...
    public final void d(String p0){
       this.copyOnWrite();
       AudioManagerProxyEvent.k(this.instance, p0);
    }
    public final void e(String p0){
       this.copyOnWrite();
       AudioManagerProxyEvent.f(this.instance, p0);
    }
    public final void f(String p0){
       this.copyOnWrite();
       AudioManagerProxyEvent.j(this.instance, p0);
    }
    public final void g(String p0){
       this.copyOnWrite();
       AudioManagerProxyEvent.h(this.instance, p0);
    }
    ...
    public final void h(String p0){
       this.copyOnWrite();
       AudioManagerProxyEvent.g(this.instance, p0);
    }
    public final void i(String p0){
       this.copyOnWrite();
       AudioManagerProxyEvent.n(this.instance, p0);
    }
    ...
    public final void j(String p0){
       this.copyOnWrite();
       AudioManagerProxyEvent.m(this.instance, p0);
    }
    public final void k(String p0){
       this.copyOnWrite();
       AudioManagerProxyEvent.i(this.instance, p0);
    }
