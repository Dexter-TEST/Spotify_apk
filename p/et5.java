...
public final class et5 extends b implements u74	// class@0014f5 from classes.dex
{

    public void et5(){
       super(RejectedClientEventNonAuth.e());
    }
    ...
    public final void c(String p0){
       this.copyOnWrite();
       RejectedClientEventNonAuth.g(this.instance, p0);
    }
    ...
    public final void d(String p0){
       this.copyOnWrite();
       RejectedClientEventNonAuth.f(this.instance, p0);
    }
