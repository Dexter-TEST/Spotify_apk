...
public final class b83 extends b implements u74	// class@001073 from classes.dex
{

    public void b83(){
       super(InAppMessagePresentationPerformanceEvent.e());
    }
    ...
    public final void c(String p0){
       this.copyOnWrite();
       InAppMessagePresentationPerformanceEvent.f(this.instance, p0);
    }
    ...
    public final void d(String p0){
       this.copyOnWrite();
       InAppMessagePresentationPerformanceEvent.g(this.instance, p0);
    }
    public final void e(String p0){
       this.copyOnWrite();
       InAppMessagePresentationPerformanceEvent.h(this.instance, p0);
    }
