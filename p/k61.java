...
public final class k61 extends b implements u74	// class@001bb1 from classes.dex
{

    public void k61(){
       super(DeeplinkOpen.e());
    }
    ...
    public final void c(String p0){
       this.copyOnWrite();
       DeeplinkOpen.g(this.instance, p0);
    }
    ...
    public final void d(String p0){
       this.copyOnWrite();
       DeeplinkOpen.h(this.instance, p0);
    }
    public final void e(String p0){
       this.copyOnWrite();
       DeeplinkOpen.f(this.instance, p0);
    }
    public final void f(String p0){
       this.copyOnWrite();
       DeeplinkOpen.i(this.instance, p0);
    }
