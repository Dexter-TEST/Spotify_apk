...
public final class bn4 extends mn4	// class@0010fb from classes.dex
{
    public final int a;

    public void bn4(int p0){
       super();
       this.a = p0;
    }
    ...
    public final String toString(){
       return tp2.n("ShuffleModeChanged{shuffleMode=", this.a, '}');
    }
}
