...
public final class q4 extends b implements u74	// class@002330 from classes.dex
{
    ...
    public final void c(boolean p0){
       this.copyOnWrite();
       AccountAttribute.f(this.instance, p0);
    }
    ...
    public final void d(long p0){
       this.copyOnWrite();
       AccountAttribute.g(this.instance, p0);
    }
    public final void e(String p0){
       this.copyOnWrite();
       AccountAttribute.h(this.instance, p0);
    }
