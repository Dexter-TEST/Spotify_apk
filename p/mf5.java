...
public final class mf5 extends b implements u74	// class@001e86 from classes.dex
{

    public void mf5(){
       super(PlaybackFromDeeplink.e());
    }
    ...
    public final void c(String p0){
       this.copyOnWrite();
       PlaybackFromDeeplink.h(this.instance, p0);
    }
    ...
    public final void d(String p0){
       this.copyOnWrite();
       PlaybackFromDeeplink.f(this.instance, p0);
    }
    public final void e(String p0){
       this.copyOnWrite();
       PlaybackFromDeeplink.g(this.instance, p0);
    }
    public final void f(String p0){
       this.copyOnWrite();
       PlaybackFromDeeplink.i(this.instance, p0);
    }
