...
public final class jo2 extends b implements u74	// class@001b15 from classes.dex
{

    public void jo2(){
       super(HashcashSolution.e());
    }
    ...
    public final void c(Duration p0){
       this.copyOnWrite();
       HashcashSolution.g(this.instance, p0);
    }
    ...
    public final void d(h80 p0){
       this.copyOnWrite();
       HashcashSolution.f(this.instance, p0);
    }
