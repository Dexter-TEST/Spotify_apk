...
public final class rc4 extends b implements u74	// class@0024bd from classes.dex
{

    public void rc4(){
       super(MonotonicClock.e());
    }
    ...
    public final void c(long p0){
       this.copyOnWrite();
       MonotonicClock.f(this.instance, p0);
    }
    ...
    public final void d(long p0){
       this.copyOnWrite();
       MonotonicClock.g(this.instance, p0);
    }
