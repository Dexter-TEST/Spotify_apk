...
public final class iv3 extends b implements u74	// class@001a0f from classes.dex
{

    public void iv3(){
       super(LogoutNonAuth.e());
    }
    ...
    public final void c(String p0){
       this.copyOnWrite();
       LogoutNonAuth.g(this.instance, p0);
    }
    ...
    public final void d(boolean p0){
       this.copyOnWrite();
       LogoutNonAuth.i(this.instance, p0);
    }
    public final void e(String p0){
       this.copyOnWrite();
       LogoutNonAuth.f(this.instance, p0);
    }
    public final void f(boolean p0){
       this.copyOnWrite();
       LogoutNonAuth.h(this.instance, p0);
    }
