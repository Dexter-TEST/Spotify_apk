...
public final class sg5 extends b implements u74	// class@002624 from classes.dex
{

    public void sg5(){
       super(Playlist4ApiProto$OpList.e());
    }
    ...
    public final void c(Playlist4ApiProto$Op p0){
       this.copyOnWrite();
       Playlist4ApiProto$OpList.f(this.instance, p0);
    }
