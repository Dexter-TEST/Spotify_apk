...
public final class y91 extends b implements u74	// class@002d70 from classes.dex
{

    public void y91(){
       super(DeviceAndroid.e());
    }
    ...
    public final void c(String p0){
       this.copyOnWrite();
       DeviceAndroid.h(this.instance, p0);
    }
    ...
    public final void d(String p0){
       this.copyOnWrite();
       DeviceAndroid.f(this.instance, p0);
    }
    public final void e(String p0){
       this.copyOnWrite();
       DeviceAndroid.i(this.instance, p0);
    }
    public final void f(String p0){
       this.copyOnWrite();
       DeviceAndroid.j(this.instance, p0);
    }
    public final void g(int p0){
       this.copyOnWrite();
       DeviceAndroid.g(this.instance, p0);
    }
