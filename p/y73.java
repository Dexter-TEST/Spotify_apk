...
public final class y73 extends b implements u74	// class@002d62 from classes.dex
{

    public void y73(){
       super(InAppMessageDismissEvent.e());
    }
    ...
    public final void c(long p0){
       this.copyOnWrite();
       InAppMessageDismissEvent.g(this.instance, p0);
    }
    ...
    public final void d(String p0){
       this.copyOnWrite();
       InAppMessageDismissEvent.f(this.instance, p0);
    }
    public final void e(String p0){
       this.copyOnWrite();
       InAppMessageDismissEvent.i(this.instance, p0);
    }
    public final void f(String p0){
       this.copyOnWrite();
       InAppMessageDismissEvent.h(this.instance, p0);
    }
