...
public final class jp3 extends b implements u74	// class@001b1d from classes.dex
{

    public void jp3(){
       super(LitePageView.e());
    }
    ...
    public final void c(String p0){
       this.copyOnWrite();
       LitePageView.g(this.instance, p0);
    }
    ...
    public final void d(String p0){
       this.copyOnWrite();
       LitePageView.f(this.instance, p0);
    }
    public final void e(String p0){
       this.copyOnWrite();
       LitePageView.h(this.instance, p0);
    }
