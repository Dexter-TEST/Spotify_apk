...
public final class xm4 extends mn4	// class@002ca7 from classes.dex
{
    public final int a;

    public void xm4(int p0){
       super();
       this.a = p0;
    }
    ...
    public final String toString(){
       return tp2.n("SeekingStopped{positionMs=", this.a, '}');
    }
}
