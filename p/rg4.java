...
public final class rg4 extends vg4	// class@0024e1 from classes.dex
{
    public final Class m;

    public void rg4(Class p0){
       String str = "[L";
       super(true);
       if (!Parcelable.class.isAssignableFrom(p0)) {
          throw new IllegalArgumentException(p0+" does not implement Parcelable.".toString());
       }
       try{
    ...
    public final boolean equals(Object p0){
       ...
       if (p0 != null && co5.c(rg4.class, p0.getClass())) {
