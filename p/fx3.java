...
public final class fx3 extends b implements u74	// class@001657 from classes.dex
{

    public void fx3(){
       super(LyricsErrorReportingEvent.e());
    }
    ...
    public final void c(String p0){
       this.copyOnWrite();
       LyricsErrorReportingEvent.g(this.instance, p0);
    }
    ...
    public final void d(String p0){
       this.copyOnWrite();
       LyricsErrorReportingEvent.h(this.instance, p0);
    }
    public final void e(String p0){
       this.copyOnWrite();
       LyricsErrorReportingEvent.i(this.instance, p0);
    }
    public final void f(String p0){
       this.copyOnWrite();
       LyricsErrorReportingEvent.f(this.instance, p0);
    }
