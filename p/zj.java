...
public final class zj extends b implements u74	// class@002f0f from classes.dex
{

    public void zj(){
       super(ApplicationAndroid.e());
    }
    ...
    public final void c(long p0){
       this.copyOnWrite();
       ApplicationAndroid.g(this.instance, p0);
    }
    ...
    public final void d(String p0){
       this.copyOnWrite();
       ApplicationAndroid.f(this.instance, p0);
    }
