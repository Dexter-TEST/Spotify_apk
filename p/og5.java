...
public final class og5 extends b implements u74	// class@002117 from classes.dex
{

    public void og5(){
       super(Playlist4ApiProto$ListChanges.e());
    }
    ...
    public final void c(Playlist4ApiProto$Delta p0){
       this.copyOnWrite();
       Playlist4ApiProto$ListChanges.f(this.instance, p0);
    }
