...
public final class fg5 extends b implements u74	// class@0015c2 from classes.dex
{

    public void fg5(){
       super(Playlist4ApiProto$ChangeInfo.e());
    }
    ...
    public final void c(){
       this.copyOnWrite();
       Playlist4ApiProto$ChangeInfo.f(this.instance);
    }
    ...
    public final void d(Playlist4ApiProto$SourceInfo p0){
       this.copyOnWrite();
       Playlist4ApiProto$ChangeInfo.g(this.instance, p0);
    }
