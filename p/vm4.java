...
public final class vm4 extends mn4	// class@002a23 from classes.dex
{
    public final v55 a;
    public final int b;

    public void vm4(int p0){
       super();
       this.a = x55.N;
       this.b = p0;
    }
    ...
    public final String toString(){
       return tp2.n("SeekForwardClicked{pageId="+this.a+", currentPositionMs=", this.b, '}');
    }
}
