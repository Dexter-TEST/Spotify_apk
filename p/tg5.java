...
public final class tg5 extends b implements u74	// class@002768 from classes.dex
{

    public void tg5(){
       super(Playlist4ApiProto$Rem.e());
    }
    ...
    public final void c(Playlist4ApiProto$Item p0){
       this.copyOnWrite();
       Playlist4ApiProto$Rem.g(this.instance, p0);
    }
    ...
    public final void d(int p0){
       this.copyOnWrite();
       Playlist4ApiProto$Rem.f(this.instance, p0);
    }
    public final void e(){
       this.copyOnWrite();
       Playlist4ApiProto$Rem.h(this.instance);
    }
