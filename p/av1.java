...
import com.spotify.messages.EventSenderInternalErrorNonAuth;
...
public final class av1 extends b implements u74	// class@000ffa from classes.dex
{

    public void av1(){
       super(EventSenderInternalErrorNonAuth.e());
    }
    ...
    public final void c(){
       this.copyOnWrite();
       EventSenderInternalErrorNonAuth.h(this.instance);
    }
    ...
    public final void d(String p0){
       this.copyOnWrite();
       EventSenderInternalErrorNonAuth.f(this.instance, p0);
    }
    public final void e(){
       this.copyOnWrite();
       EventSenderInternalErrorNonAuth.g(this.instance);
    }
