package com.spotify.playerlimited.cosmosmodels.CosmosTypeAdapterFactory_SuppressionsAdapter_AdapterJsonAdapter;
...
public final class CosmosTypeAdapterFactory_SuppressionsAdapter_AdapterJsonAdapter extends JsonAdapter	// class@000b63 from classes.dex
{
    private final JsonAdapter nullableSetOfStringAdapter;
    private final b$b options;

    public void CosmosTypeAdapterFactory_SuppressionsAdapter_AdapterJsonAdapter(Moshi p0){
       co5.o(p0, "moshi");
       super();
    ...
    public CosmosTypeAdapterFactory$SuppressionsAdapter$Adapter fromJson(b p0){
       int i1;
       co5.o(p0, "reader");
       p0.f();
       Set set = null;
    ...
    public void toJson(i p0,CosmosTypeAdapterFactory$SuppressionsAdapter$Adapter p1){
       co5.o(p0, "writer");
       if (p1 == null) {
