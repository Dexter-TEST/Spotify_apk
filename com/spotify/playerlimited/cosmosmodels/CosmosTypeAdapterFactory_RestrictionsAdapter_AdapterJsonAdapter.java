package com.spotify.playerlimited.cosmosmodels.CosmosTypeAdapterFactory_RestrictionsAdapter_AdapterJsonAdapter;
...
public final class CosmosTypeAdapterFactory_RestrictionsAdapter_AdapterJsonAdapter extends JsonAdapter	// class@000b61 from classes.dex
{
    private final JsonAdapter nullableSetOfStringAdapter;
    private final b$b options;

    public void CosmosTypeAdapterFactory_RestrictionsAdapter_AdapterJsonAdapter(Moshi p0){
       int i = this;
       JsonAdapter obj = p0;
       co5.o(obj, "moshi");
       super();
    ...
    public CosmosTypeAdapterFactory$RestrictionsAdapter$Adapter fromJson(b p0){
       Set set13;
       CosmosTypeAdapterFactory_RestrictionsAdapter_AdapterJsonAdapter uCosmosTypeA = this;
       CosmosTypeAdapterFactory$RestrictionsAdapter$Adapter obj = p0;
       co5.o(obj, "reader");
       p0.f();
       Set set = null;
       Set set1 = set;
          ...
          switch (obj.v0(uCosmosTypeA.options)){
             ...
             label_01ad :
              ...
              case 20:
                ...
                break;
              case 21:
                i8 = uCosmosTypeA.nullableSetOfStringAdapter.fromJson(obj);
                i = set13;
                i30 = 1;
                break;
              default:
       ...
       set13 = i;
       p0.y();
       obj = new CosmosTypeAdapterFactory$RestrictionsAdapter$Adapter();
       if (i9) {
          obj.u = set;
       }
       if (i10) {
    ...
    public void toJson(i p0,CosmosTypeAdapterFactory$RestrictionsAdapter$Adapter p1){
       co5.o(p0, "writer");
       if (p1 == null) {
       ...
       p0.l0("disallow_interrupting_playback_reasons");
       this.nullableSetOfStringAdapter.toJson(p0, p1.v);
    ...
    public String toString(){
       return et0.o(74, "GeneratedJsonAdapter\(CosmosTypeAdapterFactory.RestrictionsAdapter.Adapter\)", "StringBuilder\(capacity\).…builderAction\).toString\(\)");
    }
}
