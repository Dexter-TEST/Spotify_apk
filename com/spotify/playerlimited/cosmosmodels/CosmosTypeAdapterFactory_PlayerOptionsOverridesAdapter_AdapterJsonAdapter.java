package com.spotify.playerlimited.cosmosmodels.CosmosTypeAdapterFactory_PlayerOptionsOverridesAdapter_AdapterJsonAdapter;
...
public final class CosmosTypeAdapterFactory_PlayerOptionsOverridesAdapter_AdapterJsonAdapter extends JsonAdapter	// class@000b5c from classes.dex
{
    private final JsonAdapter nullableBooleanAdapter;
    private final b$b options;

    public void CosmosTypeAdapterFactory_PlayerOptionsOverridesAdapter_AdapterJsonAdapter(Moshi p0){
       co5.o(p0, "moshi");
       super();
    ...
    public CosmosTypeAdapterFactory$PlayerOptionsOverridesAdapter$Adapter fromJson(b p0){
       int i3;
       co5.o(p0, "reader");
       p0.f();
    ...
    public void toJson(i p0,CosmosTypeAdapterFactory$PlayerOptionsOverridesAdapter$Adapter p1){
       co5.o(p0, "writer");
       if (p1 == null) {
    ...
    public String toString(){
       return et0.o(84, "GeneratedJsonAdapter\(CosmosTypeAdapterFactory.PlayerOptionsOverridesAdapter.Adapter\)", "StringBuilder\(capacity\).…builderAction\).toString\(\)");
    }
}
