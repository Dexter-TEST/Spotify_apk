package com.spotify.rcs.resolver.grpc.v0.proto.g;
import p.u74;
...
public final class g extends b implements u74	// class@000bef from classes.dex
{

    public void g(){
       super(Resolve$Context.e());
    }
    ...
    public final void c(ArrayList p0){
       this.copyOnWrite();
       Resolve$Context.f(this.instance, p0);
    }
