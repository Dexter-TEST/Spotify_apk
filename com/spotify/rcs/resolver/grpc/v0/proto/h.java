package com.spotify.rcs.resolver.grpc.v0.proto.h;
import p.u74;
...
public final class h extends b implements u74	// class@000bf0 from classes.dex
{

    public void h(){
       super(Resolve$Context$ContextEntry.e());
    }
    ...
    public final void c(String p0){
       this.copyOnWrite();
       Resolve$Context$ContextEntry.f(this.instance, p0);
    }
    ...
    public final void d(String p0){
       this.copyOnWrite();
       Resolve$Context$ContextEntry.g(this.instance, p0);
    }
