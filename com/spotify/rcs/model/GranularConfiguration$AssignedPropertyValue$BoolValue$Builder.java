package com.spotify.rcs.model.GranularConfiguration$AssignedPropertyValue$BoolValue$Builder;
...
public final class GranularConfiguration$AssignedPropertyValue$BoolValue$Builder extends b implements GranularConfiguration$AssignedPropertyValue$BoolValueOrBuilder	// class@000bb8 from classes.dex
{

    private void GranularConfiguration$AssignedPropertyValue$BoolValue$Builder(){
       super(GranularConfiguration$AssignedPropertyValue$BoolValue.access$000());
    }
    public void GranularConfiguration$AssignedPropertyValue$BoolValue$Builder(GranularConfiguration$1 p0){
       super();
    }
    public s74 build(){
       return super.build();
    ...
    public GranularConfiguration$AssignedPropertyValue$BoolValue$Builder clearValue(){
       this.copyOnWrite();
       GranularConfiguration$AssignedPropertyValue$BoolValue.access$200(this.instance);
       return this;
    }
    public Object clone(){
       return super.clone();
    ...
    public GranularConfiguration$AssignedPropertyValue$BoolValue$Builder setValue(boolean p0){
       this.copyOnWrite();
       GranularConfiguration$AssignedPropertyValue$BoolValue.access$100(this.instance, p0);
       return this;
    }
}
