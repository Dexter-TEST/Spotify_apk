package com.spotify.webapi.service.models.AlbumsPagerJsonAdapter;
...
import com.spotify.webapi.service.models.AlbumsPager;
import com.squareup.moshi.i;
import java.lang.NullPointerException;
import p.et0;

public final class AlbumsPagerJsonAdapter extends JsonAdapter	// class@000c69 from classes.dex
{
    private final JsonAdapter nullablePagerOfAlbumSimpleAdapter;
    private final b$b options;

    public void AlbumsPagerJsonAdapter(Moshi p0){
       co5.o(p0, "moshi");
       super();
    ...
    public AlbumsPager fromJson(b p0){
       int i1;
       co5.o(p0, "reader");
       p0.f();
       Pager pager = null;
       ...
       p0.y();
       AlbumsPager uAlbumsPager = new AlbumsPager();
       if (i) {
          uAlbumsPager.albums = pager;
       }
       return uAlbumsPager;
    }
    ...
    public void toJson(i p0,AlbumsPager p1){
       co5.o(p0, "writer");
       if (p1 == null) {
    ...
    public String toString(){
       return et0.o(33, "GeneratedJsonAdapter\(AlbumsPager\)", "StringBuilder\(capacity\).…builderAction\).toString\(\)");
    }
}
