package com.spotify.login.signupapi.services.model.EmailSignupResponseJsonAdapter;
...
public final class EmailSignupResponseJsonAdapter extends JsonAdapter	// class@0009a3 from classes.dex
{
    ...
    public void EmailSignupResponseJsonAdapter(Moshi p0){
       co5.o(p0, "moshi");
       super();
       String[] stringArray = new String[]{"status","username","errors"};
       b$b uob = b$b.a(stringArray);
       co5.l(uob, "of\(\"status\", \"username\", \"errors\"\)");
       this.options = uob;
       pl1 a = pl1.a;
       ...
       JsonAdapter jsonAdapter2 = p0.f(ya7.j(Map.class, typeArray), a, "errors");
       co5.l(jsonAdapter2, "moshi.adapter\(Types.newP…a\), emptySet\(\), \"errors\"\)");
       this.nullableMapOfStringStringAdapter = jsonAdapter2;
    }
    public EmailSignupResponse fromJson(b p0){
       int i3;
       EmailSignupResponseJsonAdapter tconstructor;
       int i4;
       co5.o(p0, "reader");
       int i = 0;
       ...
       while (true) {
          if (p0.T()) {
             ...
             p0.y();
             if (i2 == -8) {
                return new EmailSignupResponse(integer.intValue(), str, map);
             }
             ...
             if (tconstructor == null) {
                ...
                uClassArray[3] = tYPE;
                uClassArray[4] = ve7.c;
                tconstructor = EmailSignupResponse.class.getDeclaredConstructor(uClassArray);
                this.constructorRef = tconstructor;
                co5.l(tconstructor, "EmailSignupResponse::cla…his.constructorRef = it }");
                break ;
             }
             break ;
          }
    ...
    public void toJson(i p0,EmailSignupResponse p1){
       co5.o(p0, "writer");
       if (p1 == null) {
    ...
    public String toString(){
       return et0.o(41, "GeneratedJsonAdapter\(EmailSignupResponse\)", "StringBuilder\(capacity\).…builderAction\).toString\(\)");
    }
}
